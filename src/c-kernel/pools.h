...
_import u8 __kmemd_heap_start[];
_import u8 __kmemd_heap_end[];
...
_import u8 __kmemd_thread_intr_stack_start[];
_import u8 __kmemd_thread_intr_stack_end[];

_import u8 __kmemd_thread_exec_stack_start[];
_import u8 __kmemd_thread_exec_stack_end[];
